...
import '../../features/doctor/presentation/screens/patient_period_tracker_view_screen.dart';
...
final appRouter = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      path: '/patient-period-tracker-view',
      builder: (context, state) => const PatientPeriodTrackerViewScreen(),
    ),
    GoRoute(
      path: '/analytics',
